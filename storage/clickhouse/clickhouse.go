// Package clickhouse обеспечивает работу с базой данных
//   ClickHouse рекомендует вставлять данные пачками не менее 1000 строк,
//   поэтому собирание батчей оставлено этому "репозиторию"
package clickhouse
